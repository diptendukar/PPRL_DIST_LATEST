...
public class SetupCompletedResponse implements Event{
	...
	public SetupCompletedResponse(int type, String status, String infoMsg) {
		this.type = type;
		this.status = status;
	...
	public SetupCompletedResponse(byte[] msgBytes) {
		try {
